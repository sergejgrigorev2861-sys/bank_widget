import pytest
from src.views import events_page, get_date_range
...
def test_main_page_with_real_data():
    ...
    # Тестовые транзакции
    test_transactions = [
        {"Номер карты": "*7197", "Сумма операции": -100.0, "Категория": "Еда", "Описание": "Магазин", "Дата операции": "2021-12-31"},
        {"Номер карты": "*5091", "Сумма операции": -50.0, "Категория": "Транспорт", "Описание": "Такси", "Дата операции": "2021-12-30"},
    ]
...
def test_get_date_range_unknown_period():
    from src.views import get_date_range
